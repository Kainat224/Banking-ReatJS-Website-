    ...
    <section id='#home' className={`flex flex-col md:flex-row ${styles.paddingY} ${styles.paddingX}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col `}>
        ...
        <div className='flex flex-row justify-between items-center w-full'>
          <h1 className='flex-1 text-bold font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]'>
            The Next <br className='block md:hidden'/>{' '}
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
       ...
       {/* gradient start */}
        <div className="absolute z-[0] w-[50%] h-[50%] top-[0] bottom-20 pink__gradient" />
        <div className="absolute z-[1] w-[40%] h-[40%] top-[0] white__gradient bottom-40 rounded-full" />
